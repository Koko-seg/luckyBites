...
const WHEEL_SEGMENTS = [
  { text: "YOKO", color: "#3B82F6", textColor: "#FFFFFF" }, // Blue
  { text: "ERKA", color: "#10B981", textColor: "#FFFFFF" }, // Green
  { text: "DULUU", color: "#F59E0B", textColor: "#FFFFFF" }, // Amber
  { text: "BILGUUN", color: "#EF4444", textColor: "#FFFFFF" }, // Red
  { text: "TULGAA", color: "#8B5CF6", textColor: "#FFFFFF" }, // Purple
  { text: "KOKO", color: "#06B6D4", textColor: "#FFFFFF" }, // Cyan
  { text: "TUYA", color: "#F97316", textColor: "#FFFFFF" }, // Orange
  { text: "GANAA", color: "#EC4899", textColor: "#FFFFFF" }, // Pink
]
