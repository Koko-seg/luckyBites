...
export const Header = ()=> {
    return (
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-black  text-purple-400 mb-2 sm:mb-4 drop-shadow-2xl animate-bounce delay-500 transform -rotate-2">
        LUCKY
          </h1>
